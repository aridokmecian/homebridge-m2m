...
- Switching directly between Away and Home/Night from the Home app briefly disarms the panel before re-arming into the requested mode, since RControl's API doesn't support switching between armed modes directly.
